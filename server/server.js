...
// console.log "shouldSkip: sfwOnly #{JSON.stringify(sfwOnly)}"
  ...
  calcUserInfo = function(user) {
    var base, base1, base2, base3, e, feeling, incoming, k, n, nickname, otherUser, outgoing, ref, u, userInfo;
    userInfo = {
      added: [],
      opinions: {},
      otherOpinions: {
