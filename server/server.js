...
(function() {
  var Bottleneck, autoPlayNext, bodyParser, calcEntryStrings, entryFromArg, express, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getTime, getYoutubeData, history, https, isAnyoneCasting, isCasting, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, main, now, opinions, parseDuration, play, playNext, playlist, queue, refreshDashboards, run, saveOpinions, savePlaylist, saveState, secrets, serverEpoch, sockets, updateCasts, updateOpinion, updateOpinions, ytdl;
