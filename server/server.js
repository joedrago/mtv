...
(function() {
  var AUTOSKIPLIST_COUNT, Bottleneck, YOUTUBE_USER, autoPlayNext, autoskip, autoskipCount, autoskipList, autoskipTimeout, bodyParser, calcEntryStrings, calcLicensingInfo, calcOther, calcUserInfo, checkAutoskip, checkIfEveryoneLeft, companies, constants, dashboardsRefreshNeeded, discordAuth, discordEnabled, discordIndex, echoEnabled, echoNewSong, entryFromArg, express, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getNickname, getTime, getUserFromNickname, getYoutubeData, history, https, ignored, isOpinionCommand, isPlaying, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, logAutoskip, logOutput, main, nicknames, nobodyWatchingTimeout, now, opinions, output, parseDuration, play, playNext, playingName, playlist, playlistIDFromArg, prettyDuration, privacyReplacer, processOAuth, queue, queueYoutubePlaylist, queueYoutubeTrending, randomString, refreshDashboards, refreshDashboardsIfNeeded, requestDashboardRefresh, run, sanitizeUsername, saveCompanies, saveDiscordAuth, saveIgnored, saveNicknames, saveOpinions, savePlaylist, saveState, secrets, serverEpoch, sfwOnly, shouldSkip, sockets, someoneIsWatchingWithAutoskip, songEnding, songEndingTimeout, splitArtist, trimAllWhitespace, updateNickname, updateNicknames, updateOpinion, updateOpinions, ytdl;
