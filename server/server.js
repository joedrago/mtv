...
// console.log "shouldSkip: sfwOnly #{JSON.stringify(sfwOnly)}"
  ...
  autoskip = function() {
    ...
    if (echoEnabled && echoNewSong) {
      ...
      feelings = [];
      for (m = 0, len = opinionOrder.length; m < len; m++) {
        o = opinionOrder[m];
