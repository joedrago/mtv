...
(function() {
  ...
  load = function() {
    var id, len, len1, loadedList, m, n, p, ref, ref1, state;
  ...
  saveState = function() {
    var e, len, len1, m, n, savedHistory, savedQueue, state;
    savedQueue = [];
    ...
    savedHistory = [];
    for (n = 0, len1 = history.length; n < len1; n++) {
      e = history[n];
    ...
    return new Promise(function(resolve, reject) {
      ...
      req = https.request(url, function(res) {
        ...
        return res.on('end', function() {
          var chosenThumb, data, e, i, index, item, j, len, len1, len2, m, n, q, ref, ref1, saved, thumb, thumbType, thumbUrl, trendingQueue, unshuffledTrendingQueue;
          data = null;
          try {
          ...
          if ((data.items != null) && (data.items.length > 0)) {
            ...
            for (q = 0, len2 = trendingQueue.length; q < len2; q++) {
              e = trendingQueue[q];
              queue.unshift(e);
            }
          }
  ...
  run = async function(args, user) {
    var anonCount, cmd, count, e, extraSkips, i, len, m, n, name, name1, nameString, newValue, oldValue, other, property, ref, ref1, ret, strs, title;
    cmd = 'who';
    if (args.length > 0) {
      cmd = args[0];
      cmd = cmd.replace(/^ +/, "");
    ...
    switch (cmd) {
      ...
      case 'skip':
        ...
        for (i = n = 0, ref1 = extraSkips; (0 <= ref1 ? n < ref1 : n > ref1); i = 0 <= ref1 ? ++n : --n) {
          queue.shift();
        }
        e = playNext();
        if (ret == null) {
  ...
  findMissingYoutubeInfo = function() {
    var foundCount, k, len, m, missingTitleCount, v;
