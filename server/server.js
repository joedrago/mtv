...
(function() {
  var AUTOSKIPLIST_COUNT, Bottleneck, YOUTUBE_USER, autoPlayNext, autoskip, autoskipCount, autoskipList, autoskipTimeout, bodyParser, calcEntryStrings, calcOther, calcUserInfo, checkAutoskip, dashboardsRefreshNeeded, discordEnabled, discordIndex, echoEnabled, echoNewSong, entryFromArg, express, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getTime, getYoutubeData, history, https, isAnyoneCasting, isCasting, isPlaying, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, logAutoskip, logOutput, main, now, opinions, output, parseDuration, play, playNext, playingName, playlist, prettyDuration, queue, queueYoutubeTrending, refreshDashboards, refreshDashboardsIfNeeded, requestDashboardRefresh, run, sanitizeUsername, saveOpinions, savePlaylist, saveState, secrets, serverEpoch, sfwOnly, shouldSkip, sockets, songEnding, songEndingTimeout, splitArtist, updateCasts, updateDiscord, updateOpinion, updateOpinions, ytdl;
