...
(function() {
  var Bottleneck, DEBUG_HACKS, bodyParser, entryFromArg, express, fs, getColonTime, getLetterTime, getTime, getTitle, history, https, lastPlayed, limiter, loadPlaylist, main, play, playNext, playlist, queue, run, savePlaylist, secrets, sockets;
