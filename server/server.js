...
(function() {
  ...
  updateDiscord = function() {
    if ((discordClient == null) || (discordChannel == null) || !discordClientReady || (lastPlayed == null)) {
      return;
    }
  ...
  main = async function(argv) {
    ...
    load();
    if (secrets.discordToken && secrets.discordChannel) {
      console.log("Discord enabled, logging in...");
      discordChannel = secrets.discordChannel;
      if (secrets.discordPrefix != null) {
