...
(function() {
  var AUTOSKIPLIST_COUNT, Bottleneck, MAX_BLOCK_COUNT, YOUTUBE_USER, autoPlayNext, autoskip, autoskipCount, autoskipList, autoskipTimeout, bodyParser, calcEntryStrings, calcLicensingInfo, calcOther, calcUserInfo, calcUserOpinions, checkAutoskip, checkIfEveryoneLeft, companies, constants, dashboardsRefreshNeeded, discordAuth, discordEnabled, discordIndex, echoEnabled, echoNewSong, entryFromArg, express, filters, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getNickname, getTime, getUserFromNickname, getYoutubeData, history, hosting, https, ignored, isOpinionCommand, isPlaying, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, logAutoskip, logOutput, main, nicknames, nobodyWatchingTimeout, now, opinions, output, pad, parseDuration, play, playNext, playingName, playlist, playlistIDFromArg, prettyDuration, privacyReplacer, processOAuth, queue, queueYoutubePlaylist, queueYoutubeTrending, randomShortString, randomString, refreshDashboards, refreshDashboardsIfNeeded, requestDashboardRefresh, run, sanitizeTag, sanitizeUsername, saveCompanies, saveDiscordAuth, saveIgnored, saveNicknames, saveOpinions, savePlaylist, saveState, saveUserPlaylists, secrets, serverEpoch, sfwOnly, shouldSkip, sockets, soloBroadcast, soloInfo, soloSessions, someoneIsWatchingWithAutoskip, songEnding, songEndingTimeout, splitArtist, trimAllWhitespace, updateNickname, updateNicknames, updateOpinion, updateOpinions, userPlaylists, ytdl;
