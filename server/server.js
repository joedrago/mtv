...
(function() {
  var Bottleneck, autoPlayNext, bodyParser, calcEntryStrings, calcOther, calcUserInfo, entryFromArg, express, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getTime, getYoutubeData, history, https, isAnyoneCasting, isCasting, isPlaying, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, main, now, opinions, parseDuration, play, playNext, playingName, playlist, prettyDuration, queue, refreshDashboards, run, sanitizeUsername, saveOpinions, savePlaylist, saveState, secrets, serverEpoch, sockets, updateCasts, updateOpinion, updateOpinions, ytdl;
