...
// console.log "shouldSkip: sfwOnly #{JSON.stringify(sfwOnly)}"
  ...
  run = async function(args, user) {
    var anonCount, cmd, companyArgs, concatenatedArgs, count, e, editArgs, extraSkips, i, i1, ignoreArgs, ignoreCmd, ignoreName, index, j, j1, k, k1, knownTags, l1, legalTags, len, len1, len2, len3, len4, m, m1, n1, name, name1, nameString, newCompany, newNickname, newValue, nicknameArgs, oldValue, other, playArgs, playNewlines, playQueue, playSubstring, playlistCount, playlistID, prettyList, property, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, repeatCount, ret, saved, strs, tag, tagArgs, tagName, title, unsortedQueue, v, w, x, y, z;
    cmd = 'who';
    if (args.length > 0) {
      cmd = args[0];
      cmd = cmd.replace(/^ +/, "");
