...
(function() {
  var Bottleneck, YOUTUBE_USER, autoPlayNext, bodyParser, calcEntryStrings, calcOther, calcUserInfo, dashboardsRefreshNeeded, discordEnabled, discordIndex, entryFromArg, express, findMissingYoutubeInfo, fs, getColonTime, getLetterTime, getTime, getYoutubeData, history, https, isAnyoneCasting, isCasting, isPlaying, iso8601, lastPlayed, lastPlayedDuration, lastPlayedTime, lastPlayedTimeout, limiter, load, main, now, opinions, parseDuration, play, playNext, playingName, playlist, prettyDuration, queue, queueYoutubeTrending, refreshDashboards, refreshDashboardsIfNeeded, requestDashboardRefresh, run, sanitizeUsername, saveOpinions, savePlaylist, saveState, secrets, serverEpoch, sockets, updateCasts, updateDiscord, updateOpinion, updateOpinions, ytdl;
