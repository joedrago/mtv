...
* **love**, **like**, **meh**, **bleh**, **hate** - Give a specific user (like `love user`) to filter videos with this opinion by this specific nickname

* **none** - Give a specific user (like `none user`) to filter videos in which this nickname has no opinion
