...
var Clipboard, DASHCAST_NAMESPACE, castAvailable, castSession, clearOpinion, clipboardEdit, constants, discordNickname, discordTag, discordToken, generatePermalink, i, init, launchOpen, len, logout, newSoloID, now, o, onError, onInitSuccess, opinionOrder, pageEpoch, prepareCast, qs, randomString, receiveIdentity, ref, renderClipboard, renderInfo, sendIdentity, sessionListener, sessionUpdateListener, setOpinion, showWatchForm, showWatchLink, socket, soloCommand, soloID, soloInfo, soloPause, soloRestart, soloSkip, startCast, updateOpinion, updateSoloID;
...
},{"../constants":3,"clipboard":1}],3:[function(require,module,exports){
module.exports = {
  opinions: {
    love: true,
    like: true,
